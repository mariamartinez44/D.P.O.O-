...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Consultar país que representa el atleta");
	...
	/**
	 * Ejecuta la opción para consultar el país que representa un atleta
	 */
	private void ejecutarPaisAtleta()
	{
		String atleta = input("Ingrese el nombre del atleta");
		String pais = calculadora.paisAtleta(atleta);
		System.out.println("El país que representa el atleta es "+ pais + " .");
	}
